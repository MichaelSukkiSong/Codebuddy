import './DatastructuresandalgorithmPage.scss';
import Menubar from '../../components/Menubar';

const DatastructuresandalgorithmPage = () => {
  const languageData = [
  ...
  return (
    <div className="pg-dsa-section__menubar">
      <Menubar items={menubarItems} />
    </div>
  );
};

export default DatastructuresandalgorithmPage;
